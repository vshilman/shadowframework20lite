...
public class SFPipelineRegister extends SFParameter{
	...
	static{
		...
		predefinedGlobalV.put("projection",new SFPipelineRegister(GLOBAL_MATRIX4, "projection",READ_ALL));
		predefinedGlobalV.put("texture0",new SFPipelineRegister(GLOBAL_TEXTURE, "texture0",READ_ALL));
		predefinedGlobalV.put("texture1",new SFPipelineRegister(GLOBAL_TEXTURE, "texture1",READ_ALL));
		predefinedGlobalV.put("texture2",new SFPipelineRegister(GLOBAL_TEXTURE, "texture2",READ_ALL));
		predefinedGlobalV.put("texture3",new SFPipelineRegister(GLOBAL_TEXTURE, "texture3",READ_ALL));
		predefinedGlobalV.put("texture4",new SFPipelineRegister(GLOBAL_TEXTURE, "texture4",READ_ALL));
		predefinedGlobalV.put("texture5",new SFPipelineRegister(GLOBAL_TEXTURE, "texture5",READ_ALL));
		predefinedGlobalV.put("texture6",new SFPipelineRegister(GLOBAL_TEXTURE, "texture6",READ_ALL));
		predefinedGlobalV.put("texture7",new SFPipelineRegister(GLOBAL_TEXTURE, "texture7",READ_ALL));
		predefinedGlobalV.put("position",new SFPipelineRegister(GLOBAL_FLOAT4, "position",WROTE_BY_TRANSFORM));
		...
		predefinedGlobalV.put("color3",new SFPipelineRegister(GLOBAL_FLOAT4, "color3",WROTE_BY_MATERIAL));
		predefinedGlobalV.put("color4",new SFPipelineRegister(GLOBAL_FLOAT4, "color4",WROTE_BY_MATERIAL));
		...
		predefinedGlobalV.put("P",new SFPipelineRegister(GLOBAL_FLOAT3, "P",WROTE_BY_PRIMITIVE));
		predefinedGlobalV.put("N",new SFPipelineRegister(GLOBAL_FLOAT3, "N",WROTE_BY_PRIMITIVE));
		...
		predefinedGlobalV.put("fColor2",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor2",WROTE_BY_TESSELLATION));
		predefinedGlobalV.put("fColor3",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor3",WROTE_BY_TESSELLATION));
		predefinedGlobalV.put("fColor4",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor4",WROTE_BY_TESSELLATION));
		predefinedGlobalV.put("fColor5",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor5",WROTE_BY_TESSELLATION));
		predefinedGlobalV.put("fColor6",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor6",WROTE_BY_TESSELLATION));
		predefinedGlobalV.put("fColor7",new SFPipelineRegister(GLOBAL_FLOAT4, "fColor7",WROTE_BY_TESSELLATION));
	};
