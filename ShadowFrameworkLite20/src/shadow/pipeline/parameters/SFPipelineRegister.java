...
public class SFPipelineRegister extends SFParameter{
	...
	static{
		...
		predefinedGlobalV.put("dv0",new SFPipelineRegister(GLOBAL_FLOAT3, "dv0",WROTE_BY_PRIMITIVE));
		...
		predefinedGlobalV.put("du",new SFPipelineRegister(GLOBAL_FLOAT3, "du",WROTE_BY_TRANSFORM));
		predefinedGlobalV.put("dv",new SFPipelineRegister(GLOBAL_FLOAT3, "dv",WROTE_BY_TRANSFORM));
