...
public class SFEnumObject<T> extends SFPrimitiveType implements SFWritableDataObject{
	...
	@Override
	public SFEnumObject<T> clone() {
		return new SFEnumObject<T>(elements, names);
	}
