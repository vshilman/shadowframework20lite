...
function SFSpecialPerlinNoise(){
}

SFSpecialPerlinNoise.prototype = {

	setup:function(weights, colors){
	int width;
	int height;
	this.setFormat(SFFormat.RGB8);//Warning: Not well Identified 
	int size=3;//Warning: Not well Identified 
	ByteBuffer buffer;
