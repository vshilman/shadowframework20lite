...
public class JavaBooleanExpression extends Expression{
	...
	public JavaBooleanExpression(JavaAlgebraicExpression algebraicExpression) {
		...
		bitwiseExpression.generate(javaMethodEvaluation, joglMethodEvaluation, new JavaName(algebraicExpression,bitwiseExpression));
		
		generate(new JavaName(algebraicExpression,bitwiseExpression), new JavaName(algebraicExpression,bitwiseExpression), new JavaMethodEvaluation(".",algebraicExpression,bitwiseExpression));
	}
