...
public class JsBooleanExpression extends Expression{
	...
	public JsBooleanExpression(JsAlgebraicExpression algebraicExpression) {
		...
		JsMethodEvaluation jsMethodEvaluation=new JsMethodEvaluation(".", algebraicExpression, bitwiseExpression);
		WebGlMethodEvaluation webGlMethodEvaluation=new WebGlMethodEvaluation(".", algebraicExpression, bitwiseExpression);
		bitwiseExpression.generate(jsMethodEvaluation, webGlMethodEvaluation, new JsName(algebraicExpression,bitwiseExpression));
		
		generate(new JsName(algebraicExpression,bitwiseExpression), new JsName(algebraicExpression,bitwiseExpression), new JsMethodEvaluation(".",algebraicExpression,bitwiseExpression));
	}
