...
public class Test_sv8 implements GLEventListener, KeyListener {
	...
	private void initShaders(GL2 gl) {
		int fragmentShader = Util.getShader(gl, "shaders/shader5.fs", GL2.GL_FRAGMENT_SHADER);
		int vertexShader = Util.getShader(gl, "shaders/shader5.vs", GL2.GL_VERTEX_SHADER);
