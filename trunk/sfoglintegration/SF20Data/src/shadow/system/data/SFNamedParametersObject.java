...
public class SFNamedParametersObject implements SFWritableDataObject{
	...
	private static SFNamedParametersObject parametersObject=new SFNamedParametersObject();
		...
		try {
			...
			if(effectiveObject!=null){
				if(effectiveObject instanceof SFParameterObject){//TODO : oh, really?
					return getParametersObject().getDataObject(((SFParameterObject)effectiveObject).getIndex());
				}
	...
	public static void setParametersObject(SFNamedParametersObject parametersObject) {
		SFNamedParametersObject.parametersObject = parametersObject;
	}
