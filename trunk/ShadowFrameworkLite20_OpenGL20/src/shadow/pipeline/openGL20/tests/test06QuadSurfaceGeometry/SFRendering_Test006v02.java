...
public class SFRendering_Test006v02 extends JFrame{

	private static final String RENDERNORMALS = "VectorsLight";
	...
	public SFRendering_Test006v02(){
		...
		try {
			...
			primitive.addPrimitiveElement(SFPipelineRegister.getFromName("du"), (SFProgramComponent)(SFPipeline.getModule("Triangle2")));
			primitive.addPrimitiveElement(SFPipelineRegister.getFromName("dv"), (SFProgramComponent)(SFPipeline.getModule("Triangle2")));
