...
*/
package shadow.pipeline.openGL20.textures;
...
public class SFGPUTexture {
	...
	float[] pr_matrix=new float[16];
	float[] mod_matrix=new float[16];
	...
	public void initShadowTexture(SFTextureData data) {
		...
		gl.glGetFloatv(GL2.GL_PROJECTION_MATRIX, pr_matrix, 0);
		gl.glLoadIdentity();
		gl.glMatrixMode(GL2.GL_MODELVIEW);
		gl.glGetFloatv(GL2.GL_MODELVIEW_MATRIX, mod_matrix, 0);
		gl.glLoadIdentity();
	...
	public void closeShadowTexture() {
		...
		gl.glMatrixMode(GL2.GL_MODELVIEW);
		gl.glLoadMatrixf(mod_matrix, 0);
		gl.glMatrixMode(GL2.GL_PROJECTION);
		gl.glLoadMatrixf(pr_matrix, 0);
		gl.glMatrixMode(GL2.GL_MODELVIEW);
