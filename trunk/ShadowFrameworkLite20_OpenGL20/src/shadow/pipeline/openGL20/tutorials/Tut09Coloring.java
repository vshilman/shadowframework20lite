...
public class Tut09Coloring extends SFBasicTutorial{
	...
	public Tut09Coloring(SFProgram program,
	...
	public static void main(String[] args) {
		...
		String[] materials={"RedMat"};
		SFProgram program=SFTutorialsUtilities.generateProgram("data/pipeline/primitive", materials, 
				"RedStep", primitive, "Triangle2", "Triangle2", "BasicTess");

		geometries=generateGeometries(primitive);
		
		Tut09Coloring tut01CurvedTubeFunction=new Tut09Coloring(program, 
				null, null, 
				null, null,
