...
public class Mushroom {
	public SFQuadsSurfaceGeometry generateGeometry(SFPrimitive primitive) {
		...
		function.getData().getRc().add(new SFVertex3fData(0.05f,0.3f,0));
		function.getData().getRc().add(new SFVertex3fData(0.05f,0.4f,0));
		function.getData().getRc().add(new SFVertex3fData(0.45f,0.5f,0));
		function.getData().getRc().add(new SFVertex3fData(0.05f,0.5f,0));
