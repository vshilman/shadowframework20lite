...
public class Example0007_TemplatePerlinTexture01 extends MainPTExamples {

	private static final String FILENAME="example0007";
	
	public static void main(String[] args) {
		SFCommonPipeline.setPipelineLocation("pipeline/","examplePipeline01");
		setFilename(FILENAME);
		execute(new Example0007_TemplatePerlinTexture01());
	}
