package shadow.pipeline.openGL20.tests.test05;
...
public class SFRendering_Test005 extends JFrame{

	private static final String BASIC_LSPN = "BasicLSPN";
	private static final String BASIC_MAT = "TexturedMat";
...
//		SFPipeline.getSfPipelineGraphics().translateModel(0,0,0);
//		
//		//draw primitives
//		SFPipeline.getSfPipelineGraphics().drawPrimitives(primitiveData, 0, 1);
		
		//SFPipeline.getSfPipelineGraphics().translateModel(-0.1f,0,0);
		//SFPipeline.getSfPipelineGraphics().translateModel(0,0.1f,0);
