...
public class SFRendering_Test006v03 extends JFrame{
	...
	public static void main(String[] args) {
		...
		SFRendering_Test006v03 universe=new SFRendering_Test006v03();
		universe.setDefaultCloseOperation(EXIT_ON_CLOSE);
		universe.setVisible(true);
		
	}
	
	public SFRendering_Test006v03(){
		...
		try {
			...
			SFQuadsSurfaceGeometry quadsSurfaceGeometry=new SFQuadsSurfaceGeometry(primitive,
					function, null, trianglesExtractor, 6, 8);
