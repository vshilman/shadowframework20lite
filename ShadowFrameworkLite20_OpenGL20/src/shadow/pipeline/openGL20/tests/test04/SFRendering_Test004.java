package shadow.pipeline.openGL20.tests.test04;
...
public class SFRendering_Test004 extends JFrame{
	...
	public static void main(String[] args) {
		...
		SFRendering_Test004 universe=new SFRendering_Test004();
		universe.setDefaultCloseOperation(EXIT_ON_CLOSE);
		universe.setVisible(true);
		
	}
	
	public SFRendering_Test004(){
	...
	public static void init(){
		...
		SFRendering_Test004.texture=SFPipeline.getSfTexturePipeline().beginNewRenderedTexture(new SFTextureData(200,200));
