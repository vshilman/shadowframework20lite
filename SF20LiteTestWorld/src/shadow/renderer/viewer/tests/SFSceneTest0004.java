...
public class SFSceneTest0004 {
	...
	public static void main(String[] args) {
		...
		SFViewerObjectsLibrary library=new SFViewerObjectsLibrary(SFGenerateLibrary.root,"test0258.sf");
		//library.getLibrary().addLibrary(((SFObjectsLibrary)(SFDataUtility.loadDataset(SFGenerateLibrary.root, "test0258.sf"))));
		...
		SFReferenceNode rootSceneNode=new SFReferenceNode();
			...
			rootSceneNode.addNode(placeModel("PlainChair", 0.0f, 0.0f, -0.6f, 1,0,+1.07f,0));
			rootSceneNode.addNode(placeModel("TexturedChair", 0.0f, 0.0f, 0.0f, 1,0,-0.57f,0));
			rootSceneNode.addNode(placeModel("PlainChair", -0.9f, 0.0f, -0.6f, 1,0,+2.07f,0));
			rootSceneNode.addNode(placeModel("TexturedChair", -0.7f, 0.0f, 0.8f, 1,0,-1.57f,0));
