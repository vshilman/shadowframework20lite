...
public class Test0308_DataXmlImportLibraryDecoder02 {
	...
	public static void main(String argv[]) {
		...
		interpreter.generateInterpretation("testsData/test0017.xml");
		...
		SFDataCenter.getDataCenter().makeDatasetAvailable("StoneMushroom", new SFDataCenterListener<SFObjectModelData>() {
			...
			public void onDatasetAvailable(String name, SFObjectModelData dataset) {
				...
				SFViewer.generateFrame(model,SFViewer.getLightStepController(),SFViewer.getRotationController());
			}
		});
	}
