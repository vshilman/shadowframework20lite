 ...
 */
public class Test0021_PipelineBrightMat extends SFAbstractTest{

	private static final String FILENAME = "test0021";

	public static void main(String[] args) {
		execute(new Test0021_PipelineBrightMat());
	}
				...
				new SFDataCenterListener<SFDataAsset<SFNode>>() {
					...
					public void onDatasetAvailable(String name,SFDataAsset<SFNode> dataset) {
						...
						for (SFNode node : mainNode) {
							...
							objectModel.getModel().getMaterialComponent().setProgram("BrightMat");
						}
	...
	public void buildTestData() {
		...
		try {
			...
			builder.generateElement("MaterialComponent", "BrightMat");
