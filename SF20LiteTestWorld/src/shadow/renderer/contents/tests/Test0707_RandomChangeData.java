 ...
 */
public class Test0707_RandomChangeData extends SFAbstractTest{

	private static final String FILENAME="test0707";
	
	public static void main(String[] args) {
		execute(new Test0707_RandomChangeData());
	}
	...
	public void viewTestData() {
		...
		final SFNode ground=iterator.next();
		final SFNode pebbles=iterator.next();
		node.removeNode(ground);
		...
		int time2=(int)(Math.random()*4000)+2000+time;
