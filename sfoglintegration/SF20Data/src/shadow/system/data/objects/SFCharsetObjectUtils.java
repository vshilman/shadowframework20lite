...
public class SFCharsetObjectUtils {
	...
	public static void readFloats(float[] floatValues,String value,String type) {
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("Malformed "+type+" : "+value);
		}
	}
	...
	public static float[] readFloats(String value,String type) {
	...
	public static void readInts(int[] intValues,String value,String type) {
		StringTokenizer tokenizer=new StringTokenizer(value,"(,)",false);
		try {
			int index=0;
			while (tokenizer.hasMoreTokens()) {
	...
	public static int[] readInts(String value,String type){
		StringTokenizer tokenizer=new StringTokenizer(value,"(,) \n",false);
		try {
	...
	public static short[] readShorts(String value,String type) {
		StringTokenizer tokenizer=new StringTokenizer(value,"(,) \n",false);
		try {
	...
	public static void readShorts(short[] shortValues,String value,String type) {
		StringTokenizer tokenizer=new StringTokenizer(value,"(,)",false);
		try {
			short index=0;
			while (tokenizer.hasMoreTokens()) {
	...
	public static void readCharsetObjects(SFCharsetObject[] objects,String value,String type) {
		StringTokenizer tokenizer=new StringTokenizer(value,"(,)",false);
		try {
			short index=0;
			while (tokenizer.hasMoreTokens()) {
