...
public class Tut07StencilMask extends SFTutorial{
	...
	public static void main(String[] args) {
		...
		tut07stencilMask.programTexture=SFTutorialsUtilities.generateImageProgram("../ShadowFramework2.0_OpenGL20/data/pipeline/primitive", materials02, "BasicYellowColor");
