...
public class TwoPointLights extends SFTutorial {
	...
	public static void main(String[] args) {
		...
		TwoPointLights test=new TwoPointLights();
		...
		try {
			...
			test.programShow=SFPipeline.getStaticProgram(primitive,materials, "TwoLights");
			...
			//Light
			SFPipelineStructure lightStructure=SFPipeline.getStructure("PLight02");
			List<SFParameteri> lparameters=new ArrayList<SFParameteri>();
		...
		test.prepareFrame("Two Point Lights", 600, 600);	
